...
| `API&#95;CRYPTO&#95;KEY`<br><span class="cfg-src">string · application.yml:132</span> |  | api crypto key<br><strong>可选；未设置时使用 application.yml 默认值</strong><br><strong>注意</strong>：敏感值不得提交、打印或进入报告；生产使用 Secret 管理并轮换。 / 当前 YAML 路径错误且未确认模块依赖，实际不生效。 |
...
| `ypbin.sse.enabled`<br><span class="cfg-src">boolean · application.yml:121</span> | true | SSE 开关（当前 key 与 starter 不匹配）<br><strong>必填：对应组件启用时生效</strong><br>可选值：true / false<br><strong>注意</strong>：starter 实际 key 为 ypbin.se.enabled。 |
...
| `captcha.sensitive-words.replacement`<br><span class="cfg-src">string · application.yml:128</span> | &#42; | captcha.sensitive-words.replacement 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.i18n.enabled`<br><span class="cfg-src">boolean · application.yml:130</span> | true | captcha.i18n.enabled 配置<br><strong>必填：对应组件启用时生效</strong><br>可选值：true / false<br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.api-crypto.key`<br><span class="cfg-src">string · application.yml:132</span> |  | captcha.api-crypto.key 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.observability.enabled`<br><span class="cfg-src">boolean · application.yml:136</span> | true | captcha.observability.enabled 配置<br><strong>必填：对应组件启用时生效</strong><br>可选值：true / false<br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.observability.request-id-header`<br><span class="cfg-src">string · application.yml:137</span> | X-Request-Id | captcha.observability.request-id-header 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.observability.mdc-key`<br><span class="cfg-src">string · application.yml:138</span> | requestId | captcha.observability.mdc-key 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.api-doc.enabled`<br><span class="cfg-src">boolean · application.yml:140</span> | true | captcha.api-doc.enabled 配置<br><strong>必填：对应组件启用时生效</strong><br>可选值：true / false<br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.api-doc.title`<br><span class="cfg-src">string · application.yml:141</span> | ypbin-admin API | captcha.api-doc.title 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.api-doc.description`<br><span class="cfg-src">string · application.yml:142</span> | 企业级后台管理系统接口文档 | captcha.api-doc.description 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.api-doc.version`<br><span class="cfg-src">string · application.yml:143</span> | 1.0.0 | captcha.api-doc.version 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
| `captcha.api-doc.contact.name`<br><span class="cfg-src">string · application.yml:145</span> | wenbin | captcha.api-doc.contact.name 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：YAML 层级错误：不会绑定预期 ypbin.&#42; starter 属性。 |
...
| `management.endpoints.web.exposure.include`<br><span class="cfg-src">string · application.yml:165</span> | health,info | management.endpoints.web.exposure.include 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：当前未引入 Actuator。 |
| `management.endpoint.health.show-details`<br><span class="cfg-src">string · application.yml:168</span> | when&#95;authorized | management.endpoint.health.show-details 配置<br><strong>必填：对应组件启用时生效</strong><br><strong>注意</strong>：当前未引入 Actuator。 |
