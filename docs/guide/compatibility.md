...
| 产品 | 当前版本 | 状态 | 运行时 | 关键依赖 |
| --- | --- | --- | --- | --- |
| ypbin-starter | `1.3.0` | 稳定 | Java 17 | Spring Boot 3.5.16 |
...
- 只在业务服务中接入基础能力：使用 starter 稳定版 1.3.0（Java 17 / Spring Boot 3.5.16 基线）。
- 联调管理系统：admin 1.0.0-SNAPSHOT 与 starter 1.4.0-SNAPSHOT 配套（Java 21 / Spring Boot 4.1.0）。
