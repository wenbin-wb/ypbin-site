...
稳定接入以 starter v${VERSION} 为基线（Java 21 / Spring Boot 4.1）。正在联调的 admin @ADMIN_VERSION@ 使用 starter ${VERSION}；admin-ui @ADMIN_UI_VERSION@ 是私有工作区版本。各产品的当前版本状态见 [发布状态](/releases)。
